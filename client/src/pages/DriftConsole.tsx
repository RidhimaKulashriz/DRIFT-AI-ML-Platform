...
const publicDatasetSamples: EvidenceItem[] = [{
  ...
  storageUrl: "/manus-storage/brazil-road-defect-raw_b00c0a29.jpg",
  mediaKind: "photo",
  source: "simulator",
  latitude: null,
  longitude: null,
