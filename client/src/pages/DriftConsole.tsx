...
const infrastructureFootageSamples: InfrastructureFootageSample[] = [
  ...
  { id: -202, fileName: "Railway line pass · real reference footage", storageUrl: "https://videos.pexels.com/video-files/4907960/4907960-hd_1920_1080_30fps.mp4", mediaKind: "video", source: "reference", latitude: null, longitude: null, analysis: "Frame-verified observation: rails, sleepers, ballast, and fasteners are visible. No broken rail, displaced sleeper, or measurable misalignment is confirmed in the sampled source frames; the overlay marks the area that requires a calibrated railway inspection.", detectionMethod: "Frame verification + condition review overlay", detections: [{ label: "TRACK CONDITION REVIEW ZONE · NOT CONFIRMED DAMAGE", status: "review", start: 0, end: 99, box: { left: 39, top: 7, width: 49, height: 86 }, note: "Track components are visible; no specific failure is confirmed from this footage." }], sourceUrl: "https://www.pexels.com/video/drone-flying-from-the-the-railway-track-4907960/", provenance: { kind: "real-reference-video", author: "Pexels contributor", license: "Pexels free-use", sourceUrl: "https://www.pexels.com/video/drone-flying-from-the-the-railway-track-4907960/", note: "Reference footage only; not DRIFT field evidence." } },
  { id: -203, fileName: "Bridge underside pass · real reference footage", storageUrl: "https://videos.pexels.com/video-files/36553220/15498637_3840_2160_25fps.mp4", mediaKind: "video", source: "reference", latitude: null, longitude: null, analysis: "Frame-verified observation: a real bridge inspection scene and underside work area are visible. A close-up crack is not confirmed in the sampled frames; the overlay marks the underside review zone for an engineer-led inspection.", detectionMethod: "Frame verification + underside review overlay", detections: [{ label: "UNDERSIDE INSPECTION ZONE · NOT CONFIRMED CRACK", status: "review", start: 0, end: 99, box: { left: 43, top: 8, width: 34, height: 45 }, note: "Inspection area is visible at a distance; no crack confirmation is made." }], sourceUrl: "https://www.pexels.com/download/video/36553220/", provenance: { kind: "real-reference-video", author: "Pexels contributor", license: "Pexels free-use", sourceUrl: "https://www.pexels.com/download/video/36553220/", note: "Reference footage only; not DRIFT field evidence." } },
];
...
function InfrastructureFootageEvidence({ onPreview }: { onPreview: (item: EvidenceItem) => void }) {
  return <section className="infrastructure-footage-section" aria-labelledby="infrastructure-footage-title">
    <div className="workspace-header"><div><span className="eyebrow">REAL REFERENCE FOOTAGE · FRAME DETECTION</span><h2 id="infrastructure-footage-title">Infrastructure inspection set</h2><p className="workspace-lede">Each clip now shows a frame-grounded overlay. The road clip contains a visible crack/breakup highlight; railway and bridge clips show calibrated review zones where the sampled footage does not prove a specific failure.</p></div><span className="evidence-set-count">03 CLIPS</span></div>
...
export default function DriftConsole() {
  ...
  const downloadDemoPdf = () => {
    ...
    demoPdf.mutate({ name: transientSimulatorRun.name });
  };
