...
class OAuthService {
  constructor(private client: ReturnType<typeof axios.create>) {
    if (ENV.oAuthServerUrl) {
      console.log("[OAuth] External provider configured:", ENV.oAuthServerUrl);
    } else {
      console.info("[OAuth] External provider is not configured; public mode remains available and protected actions stay disabled.");
    }
  }
