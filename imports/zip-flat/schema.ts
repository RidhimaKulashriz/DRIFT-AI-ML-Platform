...
export const contractors = pgTable("contractors", {
  id: serial("id").primaryKey(),
  legalName: varchar("legalName", { length: 220 }).notNull().unique(),
  externalReference: varchar("externalReference", { length: 160 }).unique(),
...
export const contractorUserAssignments = pgTable("contractorUserAssignments", {
  id: serial("id").primaryKey(),
...
export const cameraSources = pgTable("cameraSources", {
  id: serial("id").primaryKey(),
  ownerName: varchar("ownerName", { length: 220 }).notNull(),
  cameraCode: varchar("cameraCode", { length: 160 }).notNull().unique(),
  displayName: varchar("displayName", { length: 220 }).notNull(),
  authorizedPurpose: text("authorizedPurpose").notNull(),
  zoneLabel: varchar("zoneLabel", { length: 160 }).notNull(),
  latitude: varchar("latitude", { length: 32 }),
  longitude: varchar("longitude", { length: 32 }),
  retentionUntil: timestamp("retentionUntil", { withTimezone: true }).notNull(),
  accessClassification: varchar("accessClassification", { length: 80 }).notNull(),
  consentAndPrivacyNote: text("consentAndPrivacyNote").notNull(),
  createdBy: integer("createdBy"),
  createdAt: createdAt(),
  updatedAt: updatedAt(),
});

export const cctvCandidates = pgTable("cctvCandidates", {
  id: serial("id").primaryKey(),
  cameraSourceId: integer("cameraSourceId").notNull(),
  evidenceId: integer("evidenceId").notNull(),
  assetId: integer("assetId"),
  candidateType: varchar("candidateType", { length: 120 }).notNull(),
  zoneLabel: varchar("zoneLabel", { length: 160 }).notNull(),
  latitude: varchar("latitude", { length: 32 }),
  longitude: varchar("longitude", { length: 32 }),
  bridgeIdentity: varchar("bridgeIdentity", { length: 180 }).notNull(),
  dedupeKey: varchar("dedupeKey", { length: 180 }).notNull().unique(),
  detectionConfidence: integer("detectionConfidence").notNull(),
  localizationConfidence: integer("localizationConfidence").notNull(),
  evidenceQuality: integer("evidenceQuality").notNull(),
  temporalObservationCount: integer("temporalObservationCount").notNull(),
  qualitySignals: jsonb("qualitySignals").notNull(),
  observedAt: timestamp("observedAt", { withTimezone: true }).notNull(),
  status: cameraCandidateStatusEnum("status").notNull().default("pending_review"),
  operatorNote: text("operatorNote"),
...
export const knowledgeDocuments = pgTable("knowledgeDocuments", {
  id: serial("id").primaryKey(),
  projectScope: varchar("projectScope", { length: 160 }).notNull(),
  title: varchar("title", { length: 300 }).notNull(),
  documentType: varchar("documentType", { length: 120 }).notNull(),
  version: varchar("version", { length: 80 }).notNull(),
  approvalStatus: knowledgeDocumentStatusEnum("approvalStatus").notNull().default("draft"),
  permittedRoles: jsonb("permittedRoles").notNull(),
  storageKey: varchar("storageKey", { length: 512 }),
  storageUrl: varchar("storageUrl", { length: 768 }),
...
export const knowledgeChunks = pgTable("knowledgeChunks", {
  ...
  sectionReference: varchar("sectionReference", { length: 200 }).notNull(),
  content: text("content").notNull(),
  contentHash: varchar("contentHash", { length: 64 }).notNull(),
  scopeMetadata: jsonb("scopeMetadata").notNull(),
  createdAt: createdAt(),
});

export const knowledgeRetrievalRuns = pgTable("knowledgeRetrievalRuns", {
  id: serial("id").primaryKey(),
  actorId: integer("actorId"),
  projectScope: varchar("projectScope", { length: 160 }),
  queryHash: varchar("queryHash", { length: 64 }).notNull(),
  status: knowledgeRetrievalStatusEnum("status").notNull(),
  returnedChunkIds: jsonb("returnedChunkIds").notNull(),
  createdAt: createdAt(),
});

export const dsiAssessments = pgTable("dsiAssessments", {
  id: serial("id").primaryKey(),
  assetId: integer("assetId").notNull(),
  defectId: integer("defectId"),
  evidenceId: integer("evidenceId"),
  ...
  advisoryScore: integer("advisoryScore"),
  factorBreakdown: jsonb("factorBreakdown").notNull(),
  requiresEngineerReview: integer("requiresEngineerReview").notNull().default(1),
  createdBy: integer("createdBy"),
  createdAt: createdAt(),
});

export const contractorTickets = pgTable("contractorTickets", {
  id: serial("id").primaryKey(),
  assetId: integer("assetId").notNull(),
  defectId: integer("defectId"),
  dsiAssessmentId: integer("dsiAssessmentId"),
  contractorId: integer("contractorId"),
  assignedUserId: integer("assignedUserId"),
  title: varchar("title", { length: 220 }).notNull(),
  scopeNote: text("scopeNote").notNull(),
  zoneLabel: varchar("zoneLabel", { length: 160 }),
  latitude: varchar("latitude", { length: 32 }),
  longitude: varchar("longitude", { length: 32 }),
  priority: ticketPriorityEnum("priority").notNull(),
  ...
  inProgressAt: timestamp("inProgressAt", { withTimezone: true }),
  contractorClosureNote: text("contractorClosureNote"),
  contractorClosedAt: timestamp("contractorClosedAt", { withTimezone: true }),
  verificationCriterion: text("verificationCriterion").notNull(),
...
export const contractorTicketEvidence = pgTable("contractorTicketEvidence", {
  id: serial("id").primaryKey(),
  ticketId: integer("ticketId").notNull(),
  evidenceId: integer("evidenceId").notNull(),
  role: ticketEvidenceRoleEnum("role").notNull(),
  createdBy: integer("createdBy"),
  createdAt: createdAt(),
});

export const contractorTicketNotes = pgTable("contractorTicketNotes", {
  id: serial("id").primaryKey(),
  ticketId: integer("ticketId").notNull(),
...
export const uavFollowUpRecommendations = pgTable("uavFollowUpRecommendations", {
  id: serial("id").primaryKey(),
  ticketId: integer("ticketId").notNull(),
  cctvCandidateId: integer("cctvCandidateId"),
  assetId: integer("assetId").notNull(),
  zoneLabel: varchar("zoneLabel", { length: 160 }),
  latitude: varchar("latitude", { length: 32 }),
  longitude: varchar("longitude", { length: 32 }),
  triggerReason: text("triggerReason").notNull(),
  requiredChecks: jsonb("requiredChecks").notNull(),
  status: uavRecommendationStatusEnum("status").notNull().default("prepared"),
  expiresAt: timestamp("expiresAt", { withTimezone: true }).notNull(),
  preparedBy: integer("preparedBy").notNull(),
  createdAt: createdAt(),
  updatedAt: updatedAt(),
});

export const securityObservations = pgTable("securityObservations", {
  id: serial("id").primaryKey(),
  assetId: integer("assetId"),
  cameraSourceId: integer("cameraSourceId"),
  source: securityObservationSourceEnum("source").notNull(),
  integrationName: varchar("integrationName", { length: 160 }).notNull(),
  sourceRecordReference: varchar("sourceRecordReference", { length: 240 }).notNull().unique(),
  observationType: varchar("observationType", { length: 120 }).notNull(),
  observationSummary: text("observationSummary").notNull(),
  authorizedScope: text("authorizedScope").notNull(),
  retentionUntil: timestamp("retentionUntil", { withTimezone: true }).notNull(),
  observedAt: timestamp("observedAt", { withTimezone: true }).notNull(),
  integrityMetadata: jsonb("integrityMetadata").notNull(),
  status: securityObservationStatusEnum("status").notNull().default("pending_review"),
  reviewedBy: integer("reviewedBy"),
  reviewedAt: timestamp("reviewedAt", { withTimezone: true }),
  createdBy: integer("createdBy").notNull(),
  createdAt: createdAt(),
...
export const authorities = pgTable("authorities", {
  id: serial("id").primaryKey(),
  legalName: varchar("legalName", { length: 220 }).notNull().unique(),
  authorityType: authorityTypeEnum("authorityType").notNull(),
  contactChannel: varchar("contactChannel", { length: 300 }),
  createdBy: integer("createdBy"),
  createdAt: createdAt(),
  updatedAt: updatedAt(),
});

export const slaRules = pgTable("slaRules", {
  id: serial("id").primaryKey(),
  authorityId: integer("authorityId").notNull(),
  contractReference: varchar("contractReference", { length: 200 }).notNull(),
  responseTargetHours: integer("responseTargetHours").notNull(),
  closureTargetHours: integer("closureTargetHours").notNull(),
  escalationPolicy: jsonb("escalationPolicy").notNull(),
  businessCalendar: jsonb("businessCalendar"),
  policyVersion: varchar("policyVersion", { length: 80 }).notNull(),
  effectiveFrom: timestamp("effectiveFrom", { withTimezone: true }).notNull(),
  effectiveUntil: timestamp("effectiveUntil", { withTimezone: true }),
  createdBy: integer("createdBy"),
  createdAt: createdAt(),
  updatedAt: updatedAt(),
});
...
export const routingRules = pgTable("routingRules", {
  ...
  authorityId: integer("authorityId").notNull(),
  contractorId: integer("contractorId"),
  slaRuleId: integer("slaRuleId"),
  assetType: assetTypeEnum("assetType"),
  zoneReference: varchar("zoneReference", { length: 200 }).notNull(),
  boundarySourceReference: varchar("boundarySourceReference", { length: 768 }).notNull(),
  responsibleTeam: varchar("responsibleTeam", { length: 180 }).notNull(),
  effectiveFrom: timestamp("effectiveFrom", { withTimezone: true }).notNull(),
  effectiveUntil: timestamp("effectiveUntil", { withTimezone: true }),
  createdBy: integer("createdBy"),
  createdAt: createdAt(),
...
export const routingDecisions = pgTable("routingDecisions", {
  id: serial("id").primaryKey(),
  ticketId: integer("ticketId").notNull(),
  routingRuleId: integer("routingRuleId"),
  status: routingDecisionStatusEnum("status").notNull().default("unresolved"),
  sourceReferences: jsonb("sourceReferences").notNull(),
...
export const handoffPackages = pgTable("handoffPackages", {
  id: serial("id").primaryKey(),
  ticketId: integer("ticketId").notNull(),
  recipientAuthorityId: integer("recipientAuthorityId"),
  recipientSystem: varchar("recipientSystem", { length: 160 }),
  status: handoffStatusEnum("status").notNull().default("prepared"),
  expiresAt: timestamp("expiresAt", { withTimezone: true }),
  payload: jsonb("payload").notNull(),
  accessScope: jsonb("accessScope").notNull(),
  preparedBy: integer("preparedBy").notNull(),
...
export const publicStatusPublications = pgTable("publicStatusPublications", {
  id: serial("id").primaryKey(),
  ticketId: integer("ticketId").notNull(),
  status: publicationStatusEnum("status").notNull().default("draft"),
  publicSummary: text("publicSummary").notNull(),
  expectedCompletionAt: timestamp("expectedCompletionAt", { withTimezone: true }),
  privacyReviewNote: text("privacyReviewNote").notNull(),
  approvedBy: integer("approvedBy"),
