...
export const ticketStatusEnum = pgEnum("ticket_status", ["open", "assigned", "contractor_closed", "verification_pending", "fixed", "needs_rework", "cannot_verify"]);
